<template>
    <div>
        ...
        <base-dialog :show="isLoading" title="Authenticating..." fixed> <!-- 設定fixed為true -->
    ...
    methods: {
        async submitForm() {
            ...
            try {
                ...
                const redirectUrl = '/' + (this.$route.query.redirect || 'coaches'); // 若網址參數redirect為空值，則導址至coaches頁面
                this.$router.replace(redirectUrl); // 連結導致新頁面
            } catch (err) {
